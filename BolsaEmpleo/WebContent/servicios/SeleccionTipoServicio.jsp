...
<head>
<meta charset="UTF-8" />
<title>Selección de tipo de servicio</title>
...
<body>
	...
	<div class="container">
		...
		<%
			...
			ArrayList<TipoServicio> tiposServicio = null;
			try {
				TipoServicio tipoServicio = new TipoServicio();
				tiposServicio = tipoServicio.listarTipoServicios();
			} catch (Exception e) {
		...
		<div class="form-group">
			<form method="post" action="SeleccionServicio.jsp">
				<select name="TipoServicio" required>
					<option value="">Elegir tipo de servicio</option>
					<%
						for (TipoServicio tipoServicio : tiposServicio) {
					%>
					<option value="<%=tipoServicio.getIdTipo()%>"><%=tipoServicio.getNombreTipo()%>
					</option>
					<%
						}
					%>
