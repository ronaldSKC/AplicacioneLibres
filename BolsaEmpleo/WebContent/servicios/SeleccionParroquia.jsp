...
<body>
	...
	<nav class="navbar navbar-expand-lg  navbar-dark bg-dark">
		<a class="navbar-brand" href="#">Registro de requerimiento de servicio</a>
	...
	<br />
	<div class="container">
		<h3>Por favor, seleccione la parroquia en el cual desea solicitar
			el servicio</h3>
		<%
			String canton;
			try {
		...
		%>
		<h5>
			No se ha ingresado un cantón, por favor regrese a la pantalla
		...
		<div class="form-group">
			<form method="post" action="SeleccionTipoServicio.jsp">
				<select name="Parroquia" required>
					<option value="">Elegir parroquia</option>
					<%
					...
					%>
				</select> <br /> <br /> <input type="submit" value="Seleccionar Servicio"
